...
@property (weak, nonatomic) IBOutlet MKNumberBadgeView *mkBadge;
@property (assign, nonatomic) int selectedImageCount;
@end
...
- (void)viewDidLoad
{
    ...
    self.mkBadge.strokeWidth = 0.0f;
    [self.mkBadge setShadow:NO];
    [self.mkBadge setShine:NO];
    self.mkBadge.font = [UIFont systemFontOfSize:14];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.mkBadge.value = self.selectedImageCount;
}
